...
Some of this was pregenerated by the GNOME Foundation's [IDE ]([url](https://apps.gnome.org/Builder/)), however I've programmed all the actual text editor functionality.
